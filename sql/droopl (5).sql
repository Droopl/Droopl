...
--
-- Host: localhost:8889
-- Gegenereerd op: 11 sep 2015 om 16:19
-- Serverversie: 5.5.42
-- PHP-versie: 5.6.10
...
(55, 1, 1, '2015-09-07 11:06:35'),
(56, 1, 3, '2015-09-07 11:06:47'),
(57, 1, 4, '2015-09-07 11:06:54'),
...
(107, 'For nothing', 2, 'This is my first post', 0, '2015-08-31 15:30:16', 1, 3),
...
(178, 'Skateboard', 1, 'Ik wil cool zijn ', 0, '2015-09-08 13:33:45', 1, 0),
(179, 'Something', 1, 'Random', 0, '2015-09-10 12:58:54', 1, 0);
...
(3, 'Ferielle', 'zagnoun', 'ferielle.zagnoun@hotmail.com', 'ferielle.jpg', '1999-06-20', '', '', '', '', 'test', 'Student', '', 0, 0, 'Ik ben ferielle en ik ben heel lelijk !'),
(4, 'Wael', 'Zagnoun', 'waelzagnoun@hotmail.com', 'waelzagnoun.jpg', '1996-10-04', 'Botermelkstraat', '9', '9400', 'Appelterre-eichem', 'test', 'Lawyer', '0475434549', 0, 0, 'I''m wael , and I love rachouan'),
(5, 'Manu', 'Minne', 'manu.minne@droopl.com', 'manuminne.jpg', '2015-09-08', '', '', '', '', 'test', 'Droopl co-owner', '0475647464', 0, 0, 'Check mijn armen :p'),
(6, 'Mourad', 'Taiebi', 'mourad.taiebi@droopl.com', 'mouradtaiebi.jpg', '2015-09-22', '', '', '', '', 'test', 'Droopl co-owner', '0465363746', 0, 0, 'IN-D-STRUCT-IBLE'),
(7, 'Daniël', 'Yikik', 'daniel.yikik@droopl.com', 'danielyikik.jpg', '2015-09-14', '', '', '', '', 'test', 'Droopl co-owner', '0437347346', 0, 0, 'Everybody''s Cool, But Y''all Just Ain''t Me');
...
--
ALTER TABLE `quests`
  MODIFY `quest_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=180;
--
