...
--
-- Host: localhost:8889
-- Gegenereerd op: 30 sep 2015 om 16:52
-- Serverversie: 5.5.42
-- PHP-versie: 5.6.10
...
(1, 1, 1, '2015-09-30 06:49:02', 0),
(2, 1, 2, '2015-09-30 13:55:09', 0),
...
(73, 1, 5, '2015-09-30 06:45:40'),
(74, 1, 7, '2015-09-30 06:45:55');
...
(117, 'Gitaar', 1, 'Ik wil het gewoon niet meer', 0, '2015-09-12 12:25:07', 1, 24),
(118, 'balblabeaz', 2, 'qsdqsdqsd', 0, '2015-09-12 12:36:06', 1, 12),
(119, 'schoenen', 2, 'maat 43', 0, '2015-09-27 21:05:02', 1, 21),
(120, '', 1, 'qsdqsdqsd', 1, '2015-09-30 14:38:39', 1, 0),
(121, '', 1, 'qsdqsdsqd', 0, '2015-09-30 14:39:18', 1, 0),
(122, '', 1, 'qsdqsd', 1, '2015-09-30 14:40:42', 1, 0),
(123, '', 1, 'sqdqsdsqd', 1, '2015-09-30 14:42:16', 1, 0),
(124, '', 1, 'qsdqsd', 1, '2015-09-30 14:43:43', 1, 0),
(125, '', 1, 'qsdqsd', 1, '2015-09-30 14:45:28', 1, 0),
(126, '', 1, 'Ik heb dit niet meer nodig !', 1, '2015-09-30 14:46:14', 1, 0),
(127, '', 1, 'Een koffie apparaat', 1, '2015-09-30 14:47:30', 1, 0),
(128, '', 1, 'qsdqsd', 1, '2015-09-30 14:48:18', 1, 0),
(129, '', 1, 'Cleaner', 0, '2015-09-30 14:48:28', 1, 0);
...
--
ALTER TABLE `followers`
  MODIFY `follow_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=75;
--
...
--
ALTER TABLE `messages`
  MODIFY `message_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=148;
--
...
--
ALTER TABLE `quests`
  MODIFY `quest_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=130;
--
