...
--
-- Host: localhost:8889
-- Gegenereerd op: 30 sep 2015 om 21:19
-- Serverversie: 5.5.42
-- PHP-versie: 5.6.10
...
(139, '', 1, 'Dit is een stofzuiger zonder zakje ;)', 1, '2015-09-30 18:05:39', 1, 0),
(140, 'heey', 1, 'qsdqsdqsd', 0, '2015-09-30 18:23:19', 1, 0);
...
--
ALTER TABLE `messages`
  MODIFY `message_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=151;
--
