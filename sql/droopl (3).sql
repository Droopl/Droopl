...
--
-- Host: localhost:8889
-- Gegenereerd op: 28 aug 2015 om 19:05
-- Serverversie: 5.5.42
-- PHP-versie: 5.6.10
...
INSERT INTO `proposals` (`propo_id`, `quest_id`, `collection_id`, `propo_creation_date`) VALUES
(1, 1, 1, '2015-08-28 08:36:33'),
(2, 1, 1, '2015-08-28 08:36:33');
...
--
ALTER TABLE `quests`
  MODIFY `quest_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=107;
--
