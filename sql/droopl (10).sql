...
--
-- Host: localhost:8889
-- Gegenereerd op: 28 sep 2015 om 22:37
-- Serverversie: 5.5.42
-- PHP-versie: 5.6.10
...
(1, 'Groep 1', '2015-09-28 19:40:57', 0);
...
(119, 'schoenen', 2, 'maat 43', 0, '2015-09-27 21:05:02', 1, 7);
...
--
ALTER TABLE `quests`
  MODIFY `quest_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=121;
--
