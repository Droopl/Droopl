...
--
-- Host: localhost:8889
-- Gegenereerd op: 09 okt 2015 om 14:38
-- Serverversie: 5.5.42
-- PHP-versie: 5.6.10
...
(14, 'fixie', 2, '', 'dOYwxskA51.png', '2015-09-27 16:42:17', 0, 0),
...
INSERT INTO `communities` (`id`, `community_name`, `description`, `privacy`, `creation_date`) VALUES
(1, 'Ehb', 'This is a community just for ehb students where we can trade items and help eachother out', 0, '2015-10-09 07:45:13');
...
--
-- Gegevens worden geëxporteerd voor tabel `community_quests`
--
...
(202, 'qsdÃ©qsd', 1, 'sqdqsdÃ©qsd', 0, '2015-10-07 10:14:02', 1, 1),
(203, 'Liefde', 8, 'Ik Krijg er ni genoeg thuis', 0, '2015-10-08 13:58:38', 1, 2),
(204, 'eoifjozief', 8, 'fijgsijge', 0, '2015-10-08 13:58:59', 1, 2),
(205, 'dgqg', 8, 'gersgser', 0, '2015-10-08 14:00:00', 1, 7);
...
--
ALTER TABLE `proposals`
  MODIFY `propo_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=49;
--
...
--
ALTER TABLE `quests`
  MODIFY `quest_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=206;
--
