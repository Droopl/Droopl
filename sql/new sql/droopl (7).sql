...
-- Généré le :  Lun 19 Octobre 2015 à 14:59
...
--
-- Structure de la table `accepted_propos`
--
...
--
-- Contenu de la table `accepted_propos`
--
...
--
-- Structure de la table `community_quests`
--
...
--
-- Contenu de la table `community_quests`
--
...
--
-- Structure de la table `community_users`
--
...
--
-- Contenu de la table `community_users`
--
...
--
-- Contenu de la table `completed_quests`
--
...
--
-- Contenu de la table `conversation_users`
--
...
--
-- Structure de la table `public_quests`
--
...
--
-- Contenu de la table `public_quests`
--
...
INSERT INTO `users` (`id`, `firstname`, `lastname`, `email`, `picture`, `age`, `street`, `nr`, `zipcode`, `city`, `country`, `password`, `occupation`, `number`, `status`, `verification`, `description`, `lang`, `latitude`, `longitude`) VALUES
...
--
-- Contenu de la table `user_rating`
--
...
--
-- Index pour la table `accepted_propos`
--
...
--
-- Index pour la table `community_quests`
--
ALTER TABLE `community_quests`
 ADD PRIMARY KEY (`id`);

--
-- Index pour la table `community_users`
--
ALTER TABLE `community_users`
 ADD PRIMARY KEY (`id`);

--
-- Index pour la table `completed_quests`
--
...
--
-- Index pour la table `public_quests`
--
...
--
-- Index pour la table `user_rating`
--
...
--
-- AUTO_INCREMENT pour la table `accepted_propos`
--
ALTER TABLE `accepted_propos`
...
--
-- AUTO_INCREMENT pour la table `community_quests`
--
ALTER TABLE `community_quests`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=14;
--
-- AUTO_INCREMENT pour la table `community_users`
--
ALTER TABLE `community_users`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=16;
--
-- AUTO_INCREMENT pour la table `completed_quests`
--
ALTER TABLE `completed_quests`
...
--
-- AUTO_INCREMENT pour la table `conversation_users`
--
ALTER TABLE `conversation_users`
...
--
-- AUTO_INCREMENT pour la table `public_quests`
--
ALTER TABLE `public_quests`
...
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=10;
--
-- AUTO_INCREMENT pour la table `user_rating`
--
ALTER TABLE `user_rating`
