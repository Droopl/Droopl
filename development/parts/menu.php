...
<head>
    ...
    <link href="css/communities.css" rel="stylesheet" type="text/css">
...
<header id="menu">
    ...
    <nav>
    	<ul>
            ...
            <li><a href="?page=feed&action=feedback"class="bug icon icon-flag"><span><?php echo $_SESSION['lang']['menufeedback'];?></span></a></li>
