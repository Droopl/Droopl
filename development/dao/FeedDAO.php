...
class FeedDAO
{
	...
	public function getPublicQuests(){
		...
		$sql = 'SELECT pq.id,q.quest_id,q.views,q.item,q.quest_description,q.creation_date ,q.type, COUNT(p.quest_id) AS propocount , COUNT(s.quest_id) AS shares, u.id,u.latitude,u.longitude, u.firstname ,u.lastname,u.picture, i.image_url,c.collection_id,c.collection_image,c.item_name,c.user_id
	...
	public function getQuestsByCommunity($community_id,$offset){
		...
		$sql = 'SELECT q.quest_id,q.item,q.views,q.quest_description,q.creation_date ,q.type, COUNT(p.quest_id) AS propocount, COUNT(s.quest_id) AS shares , u.id,u.latitude,u.longitude, u.firstname ,u.lastname,u.picture, i.image_url,c.collection_id,c.collection_image,c.item_name,c.user_id
	...
	public function getQuestsByViews($user_id,$offset){
		...
		$sql = 'SELECT f.follow_id,q.views,q.quest_id,q.item,q.quest_description,q.creation_date ,q.type, COUNT(p.quest_id) AS propocount , COUNT(s.quest_id) AS shares, u.id,u.latitude,u.longitude, u.firstname ,u.lastname,u.picture, i.image_url,c.collection_id,c.collection_image,c.item_name,c.user_id
		FROM followers AS f
		LEFT OUTER JOIN public_quests AS pq
		ON f.friend_id = pq.user_id
		LEFT OUTER JOIN quests AS q
